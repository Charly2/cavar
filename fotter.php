<footer class="footer">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-4 ">
                <div class="footer-section footer-section_info">
                    <div class="footer-info">Una empresa Mexicana lider, contando con más de 20 años de experiencia en el mercado, enfocada a la fabricación y comercialización de cajas secas, refrigeradas, carrocerías especiales, campers de fibra de vidrio adecuaciones y conversiones para unidades de turismo, transporte de personal y público.</div>
                    <div class="footer-contacts">
                        <div class="footer-contacts__item"><i class="ic icon-location-pin"></i>Av. Revolución No. 157 Colonia Ejidal Emiliano Zapata Ecatepec de Morelos Edo. Mex.</div>
                        ...
                        <div class="footer-contacts__item"><i class="ic icon-earphones-alt"></i>Telefono:
                            ...
                            <a href="tel:+55 1115 5467">55 1115 5467</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        </div><span class="footer__btn-up js-scroll-top"><i class="ic fas fa-angle-up"></i></span>
    </div>
</footer>
    </div>
