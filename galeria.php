              ...
              <div class="row">
                <div class="col offset-lg-3">
                  <div class="b-title-page__wrap">
                    <h1 class="b-title-page">Galería </h1>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget widget-search section-sidebar bg-light">
                        <div class="widget-title bg-dark">Buscar</div>
                ...
                <div class="col-12 text-center">
                    <h2 class="ui-title">Conoce nuestras<span class="text-primary"> Converiones</span></h2>
